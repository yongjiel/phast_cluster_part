...
public class CgviewHTMLDocument implements CgviewConstants {
     ...
     * Constructs a new CgviewHTMLDocument object.
     *
     * @param useStyleSheet whether or not this CgviewHTMLDocument should reference an external stylesheet.
     */
    public CgviewHTMLDocument(boolean useStyleSheet) {
     ...
     */
    public void addHeader(String title, String zoom, String zoomCenter, String imageFormat, Boolean useOverlib) {
	...
	if ((useOverlib.booleanValue()) && ((imageFormat.equalsIgnoreCase("png")) || (imageFormat.equalsIgnoreCase("jpg")))) {
    ...
    public void addValidationInfo() {
        contents.add("<a href=\"http://validator.w3.org/check/referer\">Valid XHTML 1.0;</a>");
        contents.add("&nbsp;");
        contents.add("<a href=\"http://jigsaw.w3.org/css-validator/check/referer\">Valid CSS.</a>");
    }
