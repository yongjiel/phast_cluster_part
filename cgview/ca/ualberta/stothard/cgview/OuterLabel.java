...
public class OuterLabel extends Label implements CgviewConstants {
    ...
    protected void drawLabelLine() {
        ...
        if (cgview.getUseColoredLabelBackgrounds()) {
            ...
            if (extendedRadius) {
                ...
                //draw second line
                this.drawLine(lineEndRadius, lineEndRadians, tempRadius, lineEndRadians);
            } else {
	...
	textPositionX = textPositionX + cgview.getSmallestDimension() / 2 - cgview.getCenter().getX();
	textPositionY = textPositionY + cgview.getSmallestDimension() / 2 - cgview.getCenter().getY();
